...
#$IPT -A FORWARD -i tun0 -s 192.168.0.0/24 -d 0.0.0.0/0 -j ACCEPT




# Разрешим интерфейсу tun коммуникацию с другими интерфейсами в системе
#$IPT -I FORWARD -i tun+ -j ACCEPT
#$IPT -I FORWARD -i tun+ -o eth0 -m state --state RELATED,ESTABLISHED -j ACCEPT
#$IPT -I FORWARD -i eth0 -o tun+ -m state --state RELATED,ESTABLISHED -j ACCEPT
